...
<hr width="75%">
  <p align="center">
  Tip: Notar que un error muy comun puede ser realizar simplemente la asignación. (IMPORTANTE, CUANDO SE ASIGNA QUEDAN APUNTANDO 2 VARIABLES A LOS MISMO VALORES)
  </p>
<hr width="75%">
